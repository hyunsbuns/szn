//
//  SeasonAveragesTVC.swift
//  Squad
//
//  Created by Michael Litman on 2/10/16.
//  Copyright © 2016 squad. All rights reserved.
//

import UIKit

class SeasonAveragesTVC: UITableViewController {
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! SeasonTotalsTableViewCell
        ...
        {
            let label = UILabel(frame: CGRect(x: 0, y: 0, width: 50, height: 44))
            let statName = stat.value(forKey: "name") as! String
            label.text = "\(totals.getAverageForStat(statName))"
            //cell.scrollContainer.addView(label, header: statName)
        }
