...
class SeasonLeadersTVC: UITableViewController
{
    var currStat = "N/A"
    var currSeason : PFObject!
    var didGetTotals = false
    var seasonTotals = [StatTotals]()
    ...
    func sortTotals()
    {
        ...
        {
            self.seasonTotals = SquadCore.sortStatTotalsGivenStat(self.currStat, statTotals: self.seasonTotals)
        }
        else
        {
            self.seasonTotals = SquadCore.sortStatAveragesGivenStat(self.currStat, statTotals: self.seasonTotals)
        }
    }
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int
    {
        ...
        return self.seasonTotals.count
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        // Configure the cell...
        let total = self.seasonTotals[(indexPath as NSIndexPath).row]
